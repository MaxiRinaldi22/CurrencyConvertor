...
function Convert({ firstCurrency, secondCurrency, fetchResult }) {
  return (
    <>
      <section className="shadow-custom-shadow h-fit w-full rounded-md bg-white lg:border">
        <div className="h flex w-full flex-col items-center justify-between gap-3 bg-[#F2F7FE]">
          <h2 className="mt-5 text-xl font-[600] text-[#0A146E]">
            Convert {firstCurrency.title} to {secondCurrency.title}
          </h2>

          <div className="mb-3 flex items-center justify-between gap-48 lg:ml-3 lg:mr-6">
            <div className="flex items-center gap-2">
              ...
              />
              <p className="font-[600] text-[#0A146E]">
          ...
          <div>
            <div className="flex flex-col items-center justify-center gap-1 lg:gap-2">
              {DEFAUTL_CONVERSION.map((value) => (
                <p className="font-[500] text-[#2563EB]" key={value}>
